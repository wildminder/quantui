...
class QuantApp(
    ...
    # IMP-006: _finish_run_record / _ring_bell / _note_duration /
    # _current_output_path moved verbatim to quantui/run_finalization.py
    ...
    # QuantApp mixes it in below, so every QuantApp.method path is unchanged.
    ...
    # IMP-006: update_method_info / refresh_ctq_visibility / _option_live_value /
    # _set_option_display / apply_preset moved verbatim to quantui/form_state.py
    # (FormStateMixin).
    ...
    # IMP-006: _note_duration moved verbatim to quantui/run_finalization.py
    # (RunFinalizationMixin).
